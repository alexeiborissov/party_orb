...
nom="../quicksurveyP/Data/"
 ...
 dsp=getrdata(party,/gyro, /fields, /vpar, /ke,/rel, wkdir=nom+'DataR/')
 
 
 ds0=ds
 ns=n_elements(ds.x)
 nsp=n_elements(dsp.x)
...
mypath='./img/'
 ...
 psa, file=mypath+string(party, format='("ep_",i2.2,"_EparKE.eps")'), xs=13.66, ys=7.68, /inches, /encaps, bits_per_pixel=24, /color 
 i=3
 loadct, 39, /silent
  
 plot, ds0.t, ds0.ke, col=0, psym=-4, xr=[1e-3,100], yr=[1E0,1E8], charsize=cs, $
 xtitle='t (s)', symsize=ss, XSTYLE=8, YSTYLE=8, XMARGIN=[10, 12], ytitle='KE [eV]', /xlog, /ylog, position=[.11,.18,.89,.9]
 
 oplot, dsp.t, dsp.ke, col=0, psym=-1, symsize=ss;, xstyle=4, ystyle=4, XMARGIN=[10, 12], symsize=ss,$
 ;charsize=cs, yr=[1E0,2E4], xr=[1e-3,100], /noerase, /xlog
 
 ;STOP
 
 plot, ds.t, ds.Epar, col=240, psym=-4, xstyle=4, ystyle=4, XMARGIN=[10, 12], symsize=ss,$
 charsize=cs, yr=[-1,3], xr=[1e-3,100], /noerase, /xlog, position=[.11,.18,.89,.9]
 
 oplot, dsp.t, dsp.Epar, col=240, psym=-1, symsize=ss; ,xstyle=4, ystyle=4, XMARGIN=[10, 12], symsize=ss,$
 ;charsize=cs, yr=[-1e-2,1e-2], xr=[1e-3,100], /noerase, /xlog, position=[.11,.18,.89,.9]
 
 
 AXIS, YAXIS=1, YSTYLE = 1, YRANGE = [-1,3], YTITLE = 'E!d||!n!3 [Vm!e-1!n]', col=240, charsize=cs, /xlog
 ...
 bmax=max(modB0)
 psa, file=mypath+string(party, format='("ep_",i2.2,"_VB.eps")'), xs=13.66, ys=7.68, /inches, /encaps, bits_per_pixel=24, /color 
 ...
 oplot, dsp.t, nvpar0p, col=0, psym=-1, symsize=ss
 
 
 plot, ds0.t, modB0, col=58, psym=-4, xstyle=4, ystyle=4, XMARGIN=[10, 12], symsize=ss, $
 charsize=cs, yr=[1E-4,1e-1], xr=[1e-3,100], /noerase, /xlog, position=[.11,.18,.89,.9], /ylog
oplot, dsp.t, modB0p, col=58, psym=-1, symsize=ss
 
 AXIS, YAXIS=1, YSTYLE = 1, YRANGE = [1E-4,1e-1], YTITLE = '|B| [ T ]', col=58, charsize=cs, /ylog
...
;
 ...
 psa, file=mypath+string(party, format='("ep_",i2.2,"_gyro.eps")'), xs=13.66, ys=7.68, /inches, /encaps, bits_per_pixel=24, /color 
 ...
 tmax=maxtr
 plot, dsr0.t, dsr0.gyror, yr=[1e-4,10], col=0, xr=[1e-3,100], charsize=cs, xstyle=8, psym=-4, symsize=ss, $
 ;title=tit3, xtitle='t (s)', ytitle='r!dg!n [mm]', position=[.11,.18,.93,.88], /xlog
 xtitle='t (s)', ytitle='r!dg!n [m]', position=[.11,.18,.89,.9], /xlog, XMARGIN=[10, 12], /ylog
 oplot, dsp.t, dsp.gyror, symsize=ss+0.5, psym=-1, col=0
