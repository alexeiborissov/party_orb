...
plot, histo_xi1, histo_yi1, xtitle='energy (eV)', ytitle='N', /xlog, xr=[1,1e7], /ylog, yr=[1e0,6e3], linestyle=1, thick=myth, xthick=mythick, ythick=mythick, charthick=myth-1
...
oplot, [t/11604.505,t/11604.505], [1,1e8], linestyle=5
