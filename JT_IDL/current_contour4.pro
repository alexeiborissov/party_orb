...
lorentz_modj_yslice=string(f, format='("vxBx_modj_yslice",i3.3,".eps")')
lorentz_modj_zslice=string(f, format='("vxBx_modj_zslice",i3.3,".eps")')

cbtitle=string(ds.time, format='("vxB x-component (at y-midplane, t=",f7.2,")")')
cbtitle2=string(ds.time, format='("vxB x-component (at z-midplane, t=",f7.2,")")')
