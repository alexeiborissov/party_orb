...
particletrack, party, floc=nom, xyzt, lcol=[0,0,0], /op, zscl=lscl, /mm, lscl=lscl, /rel, /symb, /bsymb, frac=0.1, myxrange=[xl,xu], myyrange=[yl,yu], myzrange=[zl,zu]

ds=getrdata(party,/ke,/rel,/fields)
...
zr=where((z ge zl-1e6) and (z le zu+1e6))
