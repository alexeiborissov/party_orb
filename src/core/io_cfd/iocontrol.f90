...
! checks whether the cfd file is to be read and replaced or just read.
! this changes some common flags (cfd_reading, cfd_writing; stored in iocommon)
...
!    PRINT*, 'CFD_WRITING=', cfd_writing
!    PRINT*, 'CFD_READING=', cfd_reading
